...
const LoginPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white bg-opacity-50 backdrop-filter backdrop-blur-md rounded-lg shadow-lg p-8 max-w-md w-full">
        {/* "rounded-lg shadow-lg bg-opacity-10 bg-white bg-blur-lg bg-clip-padding backdrop-filter backdrop-blur-md text-white border-b-2 border-white p-8 max-w-md w-full"> */}

        <h1 className="text-2xl font-bold text-blue-300 text-center border-blue-300 border-b-2 pb-8">
          Library Manager
        </h1>
        ...
        <div className="flex justify-center mb-4">
          <button
            ...
            className={`w-full px-4 py-2 rounded-bl  ${
              //rounded-l-lg
              activeTab === "staff"
                ? "bg-blue-300 shadow-lg text-white"
                : "bg-opacity-50 shadow-inner shadow-blue-300 text-gray-600" //bg-gray-200 text-gray-600
            }`}
          >
            Staff
          </button>
          <button
            ...
            className={`w-full px-4 py-2 rounded-br ${
              ...
              activeTab === "member"
                ...
                : "bg-opacity-50 shadow-inner shadow-blue-300 text-gray-600"
            }`}
          >
            Member
          </button>
